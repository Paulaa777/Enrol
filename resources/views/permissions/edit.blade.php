...
@section('contenido-panel')
    ...
    <!-- col contenido  panel Editar Permission-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" value="{{ $permission->name }}" aria-label="name" required>
                                    @error('name')
    ...
    <!-- fin col contenido panel Editar Permiso-->
