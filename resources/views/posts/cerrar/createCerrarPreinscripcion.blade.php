...
@section('contenido-panel')
    ...
    <!-- col contenido  panel Añadir Post Preinscripción-->
    <div class="col my-3 mt-5 py-2 ms-3 rounded-4 border shadow">
      
        <div class="my-3">

            <div class="mb-3 text-center">
                <h3>{{__('Publicar Cierre Preinscripción')}}</h3>
            </div>        
        ...
        <div class="container my-2"> 
            ...
            <div class="container justify-content-center my-5 mx-auto rounded-4 border form-background">
                ...
                <div class="container w-auto mt-2">
                    ...
                    <form method="POST" action="{{ route('posts.cerrar.storeCerrarPreinscripcion.store') }}">
                        @csrf
    ...
    <!-- fin col contenido panel Añadir post Preinscripcion-->
