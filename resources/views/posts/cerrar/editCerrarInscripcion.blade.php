...
@section('contenido-panel')
    ...
    <!-- col contenido  panel Editar Post Inscripción-->
    <div class="col my-3 mt-5 py-2 ms-3 rounded-4 border shadow">
      
        <div class="my-3">

            <div class="mb-3 text-center">
                <h3>{{ __('Editar Posts Cierre Inscripción')}}</h3>
            </div>        
        ...
        <div class="container my-2"> 
                ...
                <div class="col-lg-auto my-2">
                    <div class="mx-auto">
                          <a href="{{ route('posts.cerrarPlazos.index') }}" class="btn btn-outline-dark nav-link p-2 border border-opacity-75 shadow-sm"> 
                            <i class="fa-solid fa-arrow-left-long me-2"></i>
                            <span class="d-none d-sm-inline">{{ __('Volver Cerrar Plazos')}}</span>
                          </a>
                    </div>
                </div>                 
            ...
            <div class="container justify-content-center my-5 mx-auto rounded-4 border form-background">
                ...
                <div class="container w-auto mt-2">
                    ...
                    <form method="POST" action="{{ route('posts.cerrar.updateCerrarInscripcion.update', $post->id) }}">
                        @method('PUT')
                        @csrf
...
{{-- @dd($post) --}}
    <!-- fin col contenido panel Editar post Inscripción-->
