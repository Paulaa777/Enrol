...
@section('contenido-panel')
    ...
    <!-- col contenido panel Añadir Participante-->
    <div class="col my-3 mt-5 py-2 ms-3 rounded-4 border shadow">
      
        <div class="my-3">

            <div class="mb-3 text-center">
                <h3>{{ __('Añadir Participante')}}</h3>
            </div>        
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="nombre_participante" name="nombre_participante" class="form-control" value="{{ old('nombre_participante')}}" aria-label="nombre_participante" required>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="apellidos_participante" name="apellidos_participante" class="form-control" value="{{ old('apellidos_participante')}}" aria-label="apellidos_participante" required>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                <div class="form-group mb-3">
                                    <label for="dni_participante"> {{ __('DNI|DNI|NIE') }}</label>
                                    <input type="text" id="dni_participante" name="dni_participante" class="form-control" value="{{ old('dni_participante')}}" aria-label="dni_participante" required>
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" id="nacimiento_participante" name="nacimiento_participante" class="form-control" value="{{ old('nacimiento_participante')}}" aria-label="nacimiento_participante" required>
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 my-2">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="tel" id="movil_participante" name="movil_participante" class="form-control" value="{{ old('movil_participante')}}" aria-label="movil_participante" required>
...
{{-- @dd(Auth::user()->id) --}}
    ...
    <!-- fin col contenido panel Añadir Participante-->
